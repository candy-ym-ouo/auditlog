...
func Defaults() Config {
	return Config{Addr: "127.0.0.1:8080", DatabasePath: "audit.db", ArchiveInterval: 100 * time.Millisecond, ArchiveThreshold: 10000, ArchiveKeepMin: 1000, ArchiveMaxAgeDays: 90}
}
